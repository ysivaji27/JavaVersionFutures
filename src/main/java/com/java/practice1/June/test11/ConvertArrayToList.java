...
public class ConvertArrayToList {
    public static void main(String[] args) {
      ...
      int sum1 = numberList.stream()
                .mapToInt(Integer::intValue) // Convert Integer to int
                      .sum();
        System.out.println("Sum of Integer List: " + sum1);

        long  minVal = numberList.stream()
                .mapToInt(Integer::intValue) // Convert Integer to int
                        .summaryStatistics().getSum();
      //  System.out.println("Minimum Value in Integer List: " + minVal);

      //  Collections.sort(numberList, Collections.reverseOrder()); // Sort in descending order

        // find 2nd largest number in the list
        int secondLargest = numberList.stream()
        ...
        // Inserting entries in random order
